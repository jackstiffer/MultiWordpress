...
- [x] **Phase 4: Polish — Dashboard + Docs** — Thin PHP dashboard (read-only stats + sudoers-whitelisted add/delete) and the documentation suite (Caddy/Cloudflare runbook, scaling-cliff doc). ✓ 2026-04-30 (static)
